...
// handleValidationAnnotation mocks base method.
func (m *MockdeviceConfigReconcilerHelperAPI) handleValidationAnnotation(ctx context.Context, devConfig *v1alpha1.DeviceConfig) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "handleValidationAnnotation", ctx, devConfig)
	ret0, _ := ret[0].(error)
	return ret0
}

// handleValidationAnnotation indicates an expected call of handleValidationAnnotation.
func (mr *MockdeviceConfigReconcilerHelperAPIMockRecorder) handleValidationAnnotation(ctx, devConfig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "handleValidationAnnotation", reflect.TypeOf((*MockdeviceConfigReconcilerHelperAPI)(nil).handleValidationAnnotation), ctx, devConfig)
}
