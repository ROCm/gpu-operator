...
type MockDaemonsetEventHandlerAPI struct {
	...
	recorder *MockDaemonsetEventHandlerAPIMockRecorder
}
...
type MockDaemonsetEventHandlerAPIMockRecorder struct {
	mock *MockDaemonsetEventHandlerAPI
}
...
func NewMockDaemonsetEventHandlerAPI(ctrl *gomock.Controller) *MockDaemonsetEventHandlerAPI {
	mock := &MockDaemonsetEventHandlerAPI{ctrl: ctrl}
	mock.recorder = &MockDaemonsetEventHandlerAPIMockRecorder{mock}
	return mock
}
...
func (mr *MockDaemonsetEventHandlerAPIMockRecorder) Create(ctx, evt, q any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockDaemonsetEventHandlerAPI)(nil).Create), ctx, evt, q)
}
...
func (mr *MockDaemonsetEventHandlerAPIMockRecorder) Delete(ctx, evt, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockDaemonsetEventHandlerAPI)(nil).Delete), ctx, evt, q)
}
...
func (mr *MockDaemonsetEventHandlerAPIMockRecorder) Generic(ctx, evt, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Generic", reflect.TypeOf((*MockDaemonsetEventHandlerAPI)(nil).Generic), ctx, evt, q)
}
...
func (mr *MockDaemonsetEventHandlerAPIMockRecorder) Update(ctx, evt, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockDaemonsetEventHandlerAPI)(nil).Update), ctx, evt, q)
}
