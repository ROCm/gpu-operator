...
| `version`                                               | amdgpu driver version (e.g., "6.2.2").<br>See ROCm Versions: https://instinct.docs.amd.com/projects/amdgpu-docs/en/latest/release/versions.html                                                                                                     | Ubuntu: `6.1.3`<br>CoreOS: `6.2.2`                                                                                                                        |
