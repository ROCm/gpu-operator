...
func (in *CommonConfigSpec) DeepCopyInto(out *CommonConfigSpec) {
	*out = *in
	if in.ImageRegistrySecrets != nil {
		in, out := &in.ImageRegistrySecrets, &out.ImageRegistrySecrets
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentValidationResult) DeepCopyInto(out *ComponentValidationResult) {
	*out = *in
	if in.Checks != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentValidationResult.
func (in *ComponentValidationResult) DeepCopy() *ComponentValidationResult {
	if in == nil {
		return nil
	}
	out := new(ComponentValidationResult)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DRADriverSpec) DeepCopyInto(out *DRADriverSpec) {
	*out = *in
	...
	if in.CmdLineArguments != nil {
		in, out := &in.CmdLineArguments, &out.CmdLineArguments
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *DeviceConfigSpec) DeepCopyInto(out *DeviceConfigSpec) {
	*out = *in
	...
	in.RemediationWorkflow.DeepCopyInto(&out.RemediationWorkflow)
...
func (in *DeviceConfigStatus) DeepCopyInto(out *DeviceConfigStatus) {
	*out = *in
	...
	out.RemediationWorkflow = in.RemediationWorkflow
...
func (in *DevicePluginSpec) DeepCopyInto(out *DevicePluginSpec) {
	*out = *in
	if in.EnableDevicePlugin != nil {
		in, out := &in.EnableDevicePlugin, &out.EnableDevicePlugin
		*out = new(bool)
		**out = **in
	}
...
func (in *DriverSpec) DeepCopyInto(out *DriverSpec) {
	*out = *in
	...
	in.VFIOConfig.DeepCopyInto(&out.VFIOConfig)
	in.KernelModuleConfig.DeepCopyInto(&out.KernelModuleConfig)
	if in.Blacklist != nil {
...
func (in *KernelModuleConfigSpec) DeepCopyInto(out *KernelModuleConfigSpec) {
	*out = *in
	if in.LoadArgs != nil {
		in, out := &in.LoadArgs, &out.LoadArgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.UnloadArgs != nil {
		in, out := &in.UnloadArgs, &out.UnloadArgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *RemediationWorkflowSpec) DeepCopyInto(out *RemediationWorkflowSpec) {
	*out = *in
	...
	if in.NodeRemediationTaints != nil {
		in, out := &in.NodeRemediationTaints, &out.NodeRemediationTaints
		*out = make([]v1.Taint, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.NodeRemediationLabels != nil {
		in, out := &in.NodeRemediationLabels, &out.NodeRemediationLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	...
	if in.AutoStartWorkflow != nil {
		in, out := &in.AutoStartWorkflow, &out.AutoStartWorkflow
		*out = new(bool)
		**out = **in
	}
}
...
func (in *RemediationWorkflowStatus) DeepCopyInto(out *RemediationWorkflowStatus) {
	*out = *in
	...
	if in.Status != nil {
		...
		*out = make(map[string]map[string][]WorkflowMetadata, len(*in))
		for key, val := range *in {
			var outVal map[string][]WorkflowMetadata
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
				in, out := &inVal, &outVal
				*out = make(map[string][]WorkflowMetadata, len(*in))
				for key, val := range *in {
					var outVal []WorkflowMetadata
					if val == nil {
						(*out)[key] = nil
					} else {
						inVal := (*in)[key]
						in, out := &inVal, &outVal
						*out = make([]WorkflowMetadata, len(*in))
						copy(*out, *in)
					}
					(*out)[key] = outVal
				}
...
func (in *RemediationWorkflowStatusList) DeepCopyInto(out *RemediationWorkflowStatusList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RemediationWorkflowStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RemediationWorkflowStatusList) DeepCopy() *RemediationWorkflowStatusList {
	...
	out := new(RemediationWorkflowStatusList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ValidationStatus) DeepCopyInto(out *ValidationStatus) {
	*out = *in
	...
	if in.Components != nil {
		...
		*out = make([]ComponentValidationResult, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
