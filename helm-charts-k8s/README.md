...
| deviceConfig.spec.configManager.image | string | `"docker.io/rocm/device-config-manager:v0.0.1"` | config manager image |
...
| deviceConfig.spec.draDriver.image | string | `"docker.io/rocm/k8s-gpu-dra-driver:v0.0.1"` | DRA driver image |
...
| deviceConfig.spec.driver.upgradePolicy.enable | bool | `false` | enable/disable automatic driver upgrade feature  |
...
| deviceConfig.spec.metricsExporter.image | string | `"docker.io/rocm/device-metrics-exporter:v0.0.1"` | metrics exporter image |
...
| deviceConfig.spec.remediationWorkflow.testerImage | string | `"docker.io/rocm/test-runner:v0.0.1"` | Container image used for testing during remediation |
...
| deviceConfig.spec.testRunner.image | string | `"docker.io/rocm/test-runner:v0.0.1"` | test runner image |
...
| kmm.controller.manager.env.relatedImageSign | string | `"docker.io/rocm/kernel-module-management-signimage:v0.0.1"` | KMM signer image for signing driver image's kernel module with given key pairs within cluster |
...
| kmm.controller.manager.env.relatedImageWorker | string | `"docker.io/rocm/kernel-module-management-worker:v0.0.1"` | KMM worker image for loading / unloading driver kernel module on worker nodes |
...
| kmm.controller.manager.image.tag | string | `"v0.0.1"` | KMM controller manager image tag |
...
| kmm.webhookServer.webhookServer.image.tag | string | `"v0.0.1"` | KMM webhook image tag |
